...
<!-- <div class="equation" align="center" data-raw-text="y = \operatorname{trunc}(x) = \begin{cases} \lfloor x \rfloor &amp; \textrm{if}\ x \geq 0 \\ \lceil x \rceil &amp; \textrm{if}\ x &lt; 0 \end{cases}" data-equation="eq:truncation_function">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/truncf/docs/img/equation_truncation_function.svg" alt="Truncation function">
    <br>
</div> -->
